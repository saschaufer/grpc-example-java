...
@Slf4j
@Service
public class ClientStreamingService extends GrpcService {

    private final ClientStreamingServiceGrpc.ClientStreamingServiceStub stub;

    public ClientStreamingService(final AppProperties appProperties, final GrpcChannelFactory channelFactory) {
        super(appProperties, channelFactory);
        stub = ClientStreamingServiceGrpc.newStub(getChannel());
    }
